...
use pdot_test_runtime::constants::currency::DOTS;
...
pub type PolkadotChainSpec =
	service::GenericChainSpec<pdot_test_runtime::GenesisConfig, Extensions>;
...
pub fn polkadot_local_testnet_genesis() -> pdot_test_runtime::GenesisConfig {
...
) -> pdot_test_runtime::GenesisConfig {
	use pdot_test_runtime as runtime;
